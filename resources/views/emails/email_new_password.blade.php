<!-- filepath: /c:/Users/Windows 10 Pro/Desktop/projeto vagas/api_vagas_dr_estagio/resources/views/emails/email_new_password.blade.php -->
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <div class="card">
        ...
        <div class="bottom-section">
            <h1 style="color: #FB670A;">Recuperação de Senha</h1>
            <div class="cardBody">
                <p>Olá {{$name}},</p>
                <p>Recebemos uma solicitação para redefinir sua senha.</p>
                <p>Aqui está sua nova senha:</p>
                <div class="credentials">
                    <p><strong>Nova Senha:</strong> {{$newPassword}}</p>
                </div>
                <p>Utilize esta senha para acessar o sistema e, se desejar, altere-a após o login.</p>
                <p>Se você não solicitou a redefinição de senha, por favor, entre em contato com o suporte imediatamente.</p>
